...
class Listingwrapper extends Component {
  ...
  render() {
    const { mainslider, thumbslider, listing } = this.props
    const settings = {
      slidesToShow: 1,
      slidesToScroll: 1,
      arrows: false,
                    ...
                    <div className='listing-feature-wrapper'>
                      <div className='listing-feature'>
                        ...
                        <span className='listing-feature-value'>
                          {listing &&
                            listing.category &&
                            listing.category.title && (listing.category.title)}
                        </span>
                      </div>
                      <div className='listing-feature'>
                  ...
                  <div className='col-lg-6 col-md-6'>
                    <div className='listing-feature-wrapper'>
                      <div className='listing-feature'>
                        ...
                        <span className='listing-feature-value'>{listing && listing.closets && (listing.closets)}</span>
                      </div>
                      <div className='listing-feature'>
                        <i className='flaticon-pillow' />
                        <h6 className='listing-feature-label'>Bed Rooms</h6>
                        <span className='listing-feature-value'>{listing && listing.rooms && (listing.rooms)}</span>
                      </div>
                      <div className='listing-feature'>
