...
const Banner = ({
  ...
  const [homeBaths, setHomeBaths] = useState([])
  const [homeBeds, setHomeBeds] = useState([])
  const [homeCategories, setHomeFilters] = useState([])
  const [homeStatuses, setHomeFilters] = useState([])
