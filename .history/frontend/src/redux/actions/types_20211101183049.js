...
export const GET_PROPERTIES_PAGE_SUCCESS = 'GET_PROPERTIES_PAGE_SUCCESS'
export const GET_PROPERTIES_PAGE_FAIL = 'GET_PROPERTIES_PAGE_FAIL'
export const GET_LOGIN_PAGE_SUCCESS = 'GET_LOGIN_PAGE_SUCCESS'
export const GET_LOGIN_PAGE_FAIL = 'GET_LOGIN_PAGE_FAIL'
export const GET_REGISTER_PAGE_SUCCESS = 'GET_REGISTER_PAGE_SUCCESS'
export const GET_REGISTER_PAGE_FAIL = 'GET_REGISTER_PAGE_FAIL'
export const GET_LEGAL_PAGE_SUCCESS = 'GET_LEGAL_PAGE_SUCCESS'
export const GET_LEGAL_PAGE_FAIL = 'GET_LEGAL_PAGE_FAIL'
export const GET_ERROR_PAGE_SUCCESS = 'GET_ERROR_PAGE_SUCCESS'
export const GET_ERROR_PAGE_FAIL = 'GET_ERROR_PAGE_FAIL'
...
export const GET_PROPERTIES_BY_PAGE_SUCCESS = 'GET_PROPERTIES_BY_PAGE_SUCCESS'
export const GET_PROPERTIES_BY_PAGE_FAIL = 'GET_PROPERTIES_BY_PAGE_FAIL'
...
export const GET_SORTED_LIST_SUCCESS = 'GET_SINGLE_PROPERTY_FAIL'
export const GET_SORTED_LIST_FAIL = 'GET_SINGLE_PROPERTY_FAIL'
...
export const GET_ARTICLES_BY_PAGE_FAIL = 'GET_ARTICLES_BY_PAGE_FAIL'
