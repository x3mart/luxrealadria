...
const pages = (state = initialState, action) => {
  ...
  switch (type) {
    ...
    case GET_ERROR_PAGE_SUCCESS:
      return {
        ...state,
        error_page: payload,
      }
    case GET_ARTICLES_PAGE_SUCCESS:
      return {
        ...state,
        articles_page: payload,
      }
    case GET_PROPERTIES_PAGE_FAIL:
    case GET_LOGIN_PAGE_FAIL:
    case GET_REGISTER_PAGE_FAIL:
    case GET_LEGAL_PAGE_FAIL:
    case GET_ERROR_PAGE_FAIL:
    case GET_ARTICLES_PAGE_FAIL:
      return {
        ...state,
      }
    default:
