...
from siteelements.views import get_home_page, get_legal_info_page, get_contacts_page, get_usefull_articles_page, get_properties_page, get_login_page, get_register_page
